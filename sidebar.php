			 ...
			 <div class="panel-subtitle text-center" style="font-size:16px;"></div>
			  ...
			  <a class="btn btn-secondary btn-block btn_hide_2" style="background:#fe8458;border-radius: 3px;box-shadow: 0 1px 2px 0 rgba(0,0,0,0.25);center;color:white;font-weight:bold;" onclick="show_more_2();">Show More</a>
			   <ul class="show_2" style="margin-left:-12px;display:none;">
				  ...
				  <li><a href="length_dist_hong_kong_units.php">Hong Kong units</a></li>
				  <li><a href="length_dist_thai_units.php">Thai units</a></li>
				  <li><a href="length_dist_optical.php">Optical</a></li>
				  <li><a href="length_dist_geographical_german.php">Geographical (German)</a></li>
				  <li><a href="length_dist_computer_equipment.php">Computer Equipment</a></li>
				  <li><a href="length_dist_typographical_ATA_system.php">Typographical (British and U.S. - ATA system)</a></li>
				  <li><a href="length_dist_typographical_Didot_system.php">Typographical (Europe - Didot system)</a></li>
				  <li><a href="length_dist_european_footwear.php">European footwear unit</a></li>
