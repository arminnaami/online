...
<html lang="en">
  <head>
    ...
    <title>Chinese units of 1930 | Download Online Free</title>
              ...
              <div class="panel-body mai-end">
                <form method = "POST">
                  ...
                  <div class="form-group inline row">
                    ...
                    <div class="col-sm-3">
                      <input type="number" class="boots_form-control form-control-xs cuo" onkeyup="from_cuo();" onkeydown="javascript: return event.keyCode == 69 ? false : true">
                    </div>
                  </div>
                </form>
              </div>
